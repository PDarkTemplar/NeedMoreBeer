...
declare module "react-i18next" {
  declare export type TFunction = (key?: ?string, data?: ?Object) => string;
  ...
  declare type Translator<P> = (<Component: React$ComponentType<P>>(
    component: Component
) =>  Class<React$Component<$Diff<React$ElementConfig<Component>, {+t: TFunction}>>>);
  ...
  declare function translate<P: {+t: TFunction} & {}>(
    locales?: Locales,
